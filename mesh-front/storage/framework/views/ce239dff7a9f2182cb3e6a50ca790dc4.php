        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <a href="<?php echo e(route('generator.index')); ?>" class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded">
                        Ir al Generador STL
                    </a>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH /home/Janpo/Mesh/mesh-front/resources/views/dashboard.blade.php ENDPATH**/ ?>